...
- **Ticket-ID scan pattern** — The plugin detects Jira ticket IDs in the page URL, tab title, or page content (e.g. a prototype URL like `.../SpaceName-12345/prototype.html`). In Settings (gear icon) you can optionally enter your Jira space name (e.g. `SpaceName-`) to narrow scanning to your space. If no ticket is found, enter the ticket ID manually — the ↻ button in the ticket field re-scans the page at any time.
